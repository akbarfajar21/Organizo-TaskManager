          ...
          <div className="flex gap-2">
            {unreadCount > 0 && (
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg font-semibold text-sm text-gray-700 dark:text-gray-300 transition-all hover:shadow-sm"
              >
                <CheckCheck size={16} />
                Tandai Semua
              </button>
